...
void UDS_GameInstanceSubsystem::InitGameLift(const FServerParameters& ServerParams)
{
	...
	LogFiles.Add(TEXT("FPS_Shooter/Saved/FPSTemplate.log"));
...
{
	TArray<FString> CommandLinesTokens;
	TArray<FString> CommandLineSwitches;
	FCommandLine::Parse(FCommandLine::Get(), CommandLinesTokens, CommandLineSwitches);
