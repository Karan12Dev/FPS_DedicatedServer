...
void UTimerWidget::NativeOnInitialized()
{
	...
	{
		OwningPlayerController->OnTimerUpdatedDelegate.AddDynamic(this, &UTimerWidget::OnTimerUpdated);
		OwningPlayerController->OnTimerStoppedDelegate.AddDynamic(this, &UTimerWidget::OnTimerStopped);
	}
